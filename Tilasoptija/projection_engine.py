"""
Projection Engine for Athletics Performance Analysis
...
Used by Coach View for form projections and advancement probability.
"""
...
def project_performance(
    ...
    Example:
        >>> project_performance([44.72, 44.89, 45.01, 45.15, 45.22], event_type='time')
        {
            'projected': 44.93,
            'range_low': 44.68,
            'range_high': 45.18,
            ...
            'trend_symbol': '↗',
            'form_score': 78.5,
            'methodology': 'Weighted average (recency bias) ± 1 SD'
        }
    """
    if not performances:
        return {
